...
const Help = () => {
    return (
        ...
        <div>
         ...
         <div className="w-[1428px] h-[1230px] relative">
  <div className="w-[1440px] h-[132px] absolute left-[-6px] top-0">
    ...
    <div className="w-[457.33px] h-14 absolute left-[491.33px] top-14 rounded-lg">
      ...
      <input className="w-[199.42px] h-[17px] absolute left-3 top-[19px] text-[15px] text-center text-[#757575]"
       placeholder=" What can we help you with?" 
      />
      <div className="w-[457.33px] h-14 absolute left-[-1px] top-[-1px] rounded-lg border border-[#757575]" />
    </div>
  </div>
  <div className="w-[1309px] h-[1098px] absolute left-[59.5px] top-[132px] bg-white">
    <div className="w-[1253px] h-[1042px] absolute left-7 top-7">
      <div className="w-[939.75px] h-[1042px] absolute left-0 top-0">
        ...
        <div className="w-[923.75px] h-[958px] absolute left-0 top-16">
          <p className="w-[905.03px] h-[17px] absolute left-0 top-[5px] text-[15px] text-left text-[#111]">
            We want to make buying your favourite Nike shoes and gear online fast and easy, and we
            accept the following payment options:
          </p>
          <div className="w-[907.75px] h-[108px] absolute left-4 top-12">
            <p className="w-[590.06px] h-[17px] absolute left-4 top-[5px] text-base text-left text-[#111]">
            ...
            <p className="w-[73.14px] h-[17px] absolute left-4 top-[85px] text-base text-left text-[#111]">
              Apple Pay
            </p>
          </div>
          <div className="w-[923.75px] h-[115px] absolute left-0 top-44">
            ...
            <div className="flex justify-start items-start absolute left-0 top-[72px] pl-[20.5px] pr-[21.625px] py-[7.5px] rounded-[30px] bg-white border hover:bg-black group  hover:border-black border-neutral-200">
              <Link href="Join">
          ...
          <div className="w-[923.75px] h-28 absolute left-0 top-[651px]">
            ...
            <p className="w-[922.04px] h-[73px] absolute left-0 top-[33px] text-base text-left text-[#111]">
              ...
              compatible Apple device running the latest OS, be signed in to your iCloud account and
              have a supported card in your Wallet. Additionally, you'll need to use Safari to use
      ...
      <div className="w-[313.25px] h-[1042px] absolute left-[939.75px] top-0 bg-white/0">
