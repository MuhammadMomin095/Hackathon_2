...
const Detail = () => {
    return (
        ...
        <div>
         ...
         <div className="w-[1440px] h-[1173px] relative">
    ...
    <div className="w-[376px] h-[1041px] absolute left-[768px] top-[-26px]">
      <div className="flex flex-col justify-start items-start absolute left-0 top-[241px] gap-0.5 pt-6 pb-px">
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative">
          <p className="flex-grow-0 flex-shrink-0 w-[374.92px] text-[15px] text-left text-[#111]">
        ...
        <div className="group flex justify-start items-start flex-grow-0 flex-shrink-0 relative overflow-hidden pl-[22.5px] pr-[23.921875px] py-[7.5px] rounded-[30px] bg-white border hover:bg-black  hover:border-black border-neutral-200">
          <svg
            width={30}
            height={30}
            viewBox="0 0 30 30"
          ...
          <Link href="Cart">
          <p className="flex-grow-0 flex-shrink-0 w-[99px] h-[29px] text-[15px] font-medium text-center text-black group-hover:text-white">
            {" "}
            Add To Cart
          </p>
          </Link>
      ...
      <p className="absolute left-0 top-[135px] text-5xl font-medium text-left text-[#111]">
        <span className="text-5xl font-medium text-left text-[#111]">Nike Air Force 1 </span>
        <br />
        <span className="text-5xl font-medium text-left text-[#111]">PLT.AF.ORM</span>
      </p>
    </div>
    <img className="w-[653px] h-[653px] absolute left-[-23px] top-[109px]" src="rectangle.png" />
  </div>
</div>;
