...
<div className="w-[1440px] h-[1450.97px] relative">
<div className="w-[1440px] h-10 absolute left-0 top-0 bg-white">
  ...
  <div className="w-[1440px] h-[4641px] absolute left-0 top-10">
    ...
    <div className="w-[1440px] h-[1329.97px] absolute left-0 top-[81px] bg-white">
      <div className="w-[450.66px] h-[636.98px] absolute left-7 top-0">
        <div className="w-[450.66px] h-[506.98px] absolute left-0 top-0 overflow-hidden bg-neutral-100">
          <img
            src="upcoming/image.png"
            className="w-[450.66px] h-[507.19px] absolute left-[-1px] top-[-1px] object-none"
          />
          <div className="w-[35.59px] h-[60px] absolute left-6 top-6">
            <p className="w-[34.65px] h-[22px] absolute left-[0.56px] top-px text-[19px] font-medium text-center text-[#111]">
              Mar
            </p>
            <p className="w-[35.79px] h-9 absolute left-0 top-6 text-[32px] font-medium text-center text-[#111]">
              24
            </p>
          </div>
        </div>
        <div className="w-[450.66px] h-[104px] absolute left-0 top-[506.98px] bg-white">
          <p className="w-[120.26px] h-[17px] absolute left-[165.3px] top-[27px] text-[15px] font-medium text-center text-[#111]">
            Air Jordan 2 Low
          </p>
          <p className="w-[110.92px] h-[27px] absolute left-[169.97px] top-12 text-[22px] font-medium text-center text-[#111]">
            Melon Tint
          </p>
        </div>
      </div>
      <div className="w-[450.66px] h-[636.98px] absolute left-[494.66px] top-0">
        <div className="w-[450.66px] h-[506.98px] absolute left-0 top-0 overflow-hidden bg-neutral-100">
          <img
            src="upcoming/image-2.png"
            className="w-[450.66px] h-[507.19px] absolute left-[-1px] top-[-1px] object-none"
          />
          <div className="w-[35.59px] h-[60px] absolute left-6 top-6">
            <p className="w-[34.65px] h-[22px] absolute left-[0.56px] top-px text-[19px] font-medium text-center text-[#111]">
        ...
        <div className="w-[450.66px] h-[104px] absolute left-0 top-[506.98px] bg-white">
          <p className="w-[154.06px] h-[17px] absolute left-[148.39px] top-[27px] text-[15px] font-medium text-center text-[#111]">
            Air Jordan 1 Low Golf
          </p>
          <p className="w-[152.26px] h-[27px] absolute left-[149.3px] top-12 text-[22px] font-medium text-center text-[#111]">
            Midnight Navy
          </p>
        </div>
      </div>
      <div className="w-[450.66px] h-[636.98px] absolute left-[961.31px] top-0">
        <div className="w-[450.66px] h-[506.98px] absolute left-0 top-0 overflow-hidden bg-neutral-100">
          <img
            src="upcoming/image-3.png"
            className="w-[450.66px] h-[507.19px] absolute left-[-1px] top-[-1px] object-none"
          />
          <div className="w-[35.59px] h-[60px] absolute left-6 top-6">
            <p className="w-[34.65px] h-[22px] absolute left-[0.56px] top-px text-[19px] font-medium text-center text-[#111]">
        ...
        <div className="w-[450.66px] h-[104px] absolute left-0 top-[506.98px] bg-white">
          <p className="w-[152.65px] h-[17px] absolute left-[149.09px] top-[27px] text-[15px] font-medium text-center text-[#111]">
            Air Max 1 '86 Original
          </p>
          <p className="w-[116.29px] h-[27px] absolute left-[167.28px] top-12 text-[22px] font-medium text-center text-[#111]">
            Big Bubble
          </p>
        </div>
      </div>
      <div className="w-[450.66px] h-[636.98px] absolute left-7 top-[652.98px]">
        <div className="w-[450.66px] h-[506.98px] absolute left-0 top-0 overflow-hidden bg-neutral-100">
          <img
            src="upcoming/image-4.png"
            className="w-[450.66px] h-[507.19px] absolute left-[-1px] top-[-1px] object-none"
          />
          <div className="w-[35.59px] h-[60px] absolute left-6 top-6">
            <p className="w-[34.65px] h-[22px] absolute left-[0.56px] top-px text-[19px] font-medium text-center text-[#111]">
        ...
        <div className="w-[450.66px] h-[104px] absolute left-0 top-[506.98px] bg-white">
          <p className="w-[222.11px] h-[17px] absolute left-[114.38px] top-[27px] text-[15px] font-medium text-center text-[#111]">
            Women's Air Max 1 '86 Original
          </p>
          <p className="w-[116.29px] h-[27px] absolute left-[167.28px] top-12 text-[22px] font-medium text-center text-[#111]">
            Big Bubble
          </p>
      ...
      <div className="w-[450.66px] h-[636.98px] absolute left-[494.66px] top-[652.98px]">
        <div className="w-[450.66px] h-[506.98px] absolute left-0 top-0 overflow-hidden bg-neutral-100">
          <img
            src="upcoming/image-5.png"
            className="w-[450.66px] h-[507.19px] absolute left-[-1px] top-[-1px] object-none"
          />
          <div className="w-[35.59px] h-[60px] absolute left-6 top-6">
            <p className="w-[34.65px] h-[22px] absolute left-[0.56px] top-px text-[19px] font-medium text-center text-[#111]">
        ...
        <div className="w-[450.66px] h-[104px] absolute left-0 top-[506.98px] bg-white">
          <p className="w-[139.29px] h-[17px] absolute left-[155.78px] top-[27px] text-[15px] font-medium text-center text-[#111]">
            Air Max 1 '86 OG G
          </p>
          <p className="w-[156.25px] h-[27px] absolute left-[147.3px] top-12 text-[23px] font-medium text-center text-[#111]">
            University Red
          </p>
        </div>
      </div>
      <div className="w-[450.66px] h-[636.98px] absolute left-[961.31px] top-[652.98px]">
        <div className="w-[450.66px] h-[506.98px] absolute left-0 top-0 overflow-hidden bg-neutral-100">
          <img
            src="upcoming/image-6.png"
            className="w-[450.66px] h-[507.19px] absolute left-[-1px] top-[-1px] object-none"
          />
          <div className="w-[35.59px] h-[60px] absolute left-6 top-6">
            <p className="w-[34.65px] h-[22px] absolute left-[0.56px] top-px text-[19px] font-medium text-center text-[#111]">
        ...
        <div className="w-[450.66px] h-[104px] absolute left-0 top-[506.98px] bg-white">
          <p className="w-[141.68px] h-[17px] absolute left-[154.58px] top-[27px] text-[15px] font-medium text-center text-[#111]">
            Women's Dunk Low
          </p>
          <p className="w-[124.31px] h-[27px] absolute left-[163.27px] top-12 text-[23px] font-medium text-center text-[#111]">
            Blue Suede
          </p>
        </div>
      </div>
